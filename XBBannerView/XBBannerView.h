...
@protocol XBBannerViewDelegate <NSObject>

-(void)xbADCollectionView:(XBBannerView *)xbADCollectionView clickAtIndex:(NSInteger)index;

@end

@interface XBBannerView : UIView
...
/** 代理 */
@property (nonatomic,weak) id <XBBannerViewDelegate> delegate;
